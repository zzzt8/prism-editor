...
import type { ImageData, MaskOptions } from '@prism/shared-types';
...
async function resizeMaskToImage(maskData: ImageData, targetWidth: number, targetHeight: number): Promise<ImageData> {
